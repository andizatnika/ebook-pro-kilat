...
export const SettingsModal: React.FC<SettingsModalProps> = ({ 
  ...
  const handleLogoutClick = async () => {
    ...
    await onLogout();
    // No need to setIsLoggingOut(false) as app will likely redirect or component will unmount
  };
          ...
          <div className="w-1/3 bg-gray-50 dark:bg-gray-900/50 border-r border-gray-100 dark:border-gray-700 p-4 space-y-2">
            ...
            <div className="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
              <button 
                ...
                className="w-full flex items-center gap-3 p-3 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
